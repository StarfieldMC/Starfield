...
using Starfield.Core.Networking.IO;
    ...
    public class MinecraftPacket : IDisposable {
        ...
        public static void Initialize() {
            ...
            Type[] packetTypes = Assembly.GetExecutingAssembly().GetTypes()
                      .Where(t => string.Equals(t.Namespace, "Starfield.Core.Networking.Packet.Client.Handshake")
                        || string.Equals(t.Namespace, "Starfield.Core.Networking.Packet.Client.Status")
                        || string.Equals(t.Namespace, "Starfield.Core.Networking.Packet.Client.Login")
                        || string.Equals(t.Namespace, "Starfield.Core.Networking.Packet.Client.Play"))
                      .ToArray();
