...
namespace nylium.Core.Networking.IO {
    ...
    public class MinecraftStream : Stream {
        ...
        public Utilities.Position.Int ReadPosition() {
        ...
        public Utilities.Identifier ReadIdentifier() {
        ...
        public Utilities.Position.Int WritePosition(Utilities.Position.Int value) {
        ...
        public Utilities.Identifier WriteIdentifier(Utilities.Identifier value) {
