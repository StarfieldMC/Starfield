...
namespace nylium.Core.Level.Storage.Formats {
    ...
    public class WaterWorldFormat : AbstractWorldFormat {
        ...
        public override async Task<bool> Save() {
            ...
            World.Chunks.Iterate(async chunk => await Save(chunk));
            ChunkWriter.Flush();
            await LookupStream.FlushAsync();
        ...
        public override async Task<bool> Load(Chunk chunk) {
            int err = 0;
        ...
        public override async Task<bool> Save(Chunk chunk) {
        ...
        public override async Task<bool> Load(PlayerEntity player) {
        ...
        public override async Task<bool> Save(PlayerEntity player) {
            Stopwatch sw = new();
            sw.Start();
