        ...
        public static void Run(string[] args) {
            ...
            foreach(dynamic item in items) {
                ...
                if(item.ContainsKey("block")) {
                    ...
                    StringBuilder arr0 = new("new int[] { ");
                    ...
                    i = string.Format(hoeTemplate, clsName, id, protocolId, maxStackSize,
                        item.uses, item.speed, item.attack_damage, item.attack_damage_bonus, "null", arr.ToString());
                ...
                generatedItems.Add($"Block{clsName}.cs", i);
            }
        }
    }
}